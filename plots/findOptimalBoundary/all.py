...
filenameK00 = "./results/scanKPF6inACND05E00"
filenameK40 = "./results/scanKPF6inACND05E40"
filenameLi00 = "./results/scanLiPF6inACND05E00"
filenameLi40 = "./results/scanLiPF6inACND05E40"
...
if 1:
    ...
    #cf = ax.tricontourf(x[mask], y[mask], z[mask], levels=20)
    #fig.colorbar(cf, ax=ax, label='z')


#    cs = ax.tricontour(x[mask], y[mask], z[mask], levels=10)
